...
<div class="max-w-2xl">
    <div class="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
        ...
        <form method="POST" action="{{ route('clientes.update', $cliente) }}" class="p-6">
            ...
            {{-- SECCIÓN SLA                           --}}
            {{-- ══════════════════════════════════════ --}}
            @php $tieneSla = old('tiene_sla', $cliente->tiene_sla); @endphp
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <input type="number" name="sla_horas_respuesta"
                                   value="{{ old('sla_horas_respuesta', $cliente->sla_horas_respuesta ?? 0) }}"
                                   min="0"
                        ...
                        <div>
                            ...
                            <input type="number" name="sla_horas_resolucion"
                                   value="{{ old('sla_horas_resolucion', $cliente->sla_horas_resolucion ?? 0) }}"
                                   min="0"
                                   class="w-full border border-gray-200 rounded-lg px-4 py-2.5 text-sm font-mono text-center focus:outline-none focus:border-red-400 focus:ring-2 focus:ring-red-100 transition-all">
                        ...
                        <div>
                            ...
                            <input type="number" name="sla_horas_cambio_equipo"
                                   value="{{ old('sla_horas_cambio_equipo', $cliente->sla_horas_cambio_equipo ?? 0) }}"
                                   min="0"
                                   class="w-full border border-gray-200 rounded-lg px-4 py-2.5 text-sm font-mono text-center focus:outline-none focus:border-red-400 focus:ring-2 focus:ring-red-100 transition-all">
