            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                ...
                <div class="sm:col-span-2">
                    ...
                    <input type="text" name="nombre" value="<?php echo e(old('nombre')); ?>" required
                           ...
                           class="w-full border border-gray-200 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:border-red-400 focus:ring-2 focus:ring-red-100 transition-all <?php echo e($errors->has('nombre') ? 'border-red-400' : ''); ?>">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div>
                    ...
                    <input type="text" name="codigo" value="<?php echo e(old('codigo')); ?>" required
                           ...
                           class="w-full border border-gray-200 rounded-lg px-4 py-2.5 text-sm font-mono focus:outline-none focus:border-red-400 focus:ring-2 focus:ring-red-100 transition-all <?php echo e($errors->has('codigo') ? 'border-red-400' : ''); ?>">
                ...
                <div class="flex items-center justify-between mb-4">
                    ...
                    <label class="relative inline-flex items-center cursor-pointer">
                        <input type="checkbox" name="tiene_sla" value="1" id="toggle_sla"
                               <?php echo e(old('tiene_sla') ? 'checked' : ''); ?>
                        ...
                        <span class="ml-3 text-sm font-semibold text-gray-700" id="sla_label">
                            <?php echo e(old('tiene_sla') ? 'Sí' : 'No'); ?>

                        </span>
                    </label>
                </div>

                <div id="sla_campos" class="<?php echo e(old('tiene_sla') ? '' : 'hidden'); ?>">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <input type="number" name="sla_horas_respuesta"
                                   value="<?php echo e(old('sla_horas_respuesta', 0)); ?>"
                                   min="0"
                        ...
                        <div>
                            ...
                            <input type="number" name="sla_horas_resolucion"
                                   value="<?php echo e(old('sla_horas_resolucion', 0)); ?>"
                                   min="0"
                                   class="w-full border border-gray-200 rounded-lg px-4 py-2.5 text-sm font-mono text-center focus:outline-none focus:border-red-400 focus:ring-2 focus:ring-red-100 transition-all">
                        ...
                        <div>
                            ...
                            <input type="number" name="sla_horas_cambio_equipo"
                                   value="<?php echo e(old('sla_horas_cambio_equipo', 0)); ?>"
                                   min="0"
                                   class="w-full border border-gray-200 rounded-lg px-4 py-2.5 text-sm font-mono text-center focus:outline-none focus:border-red-400 focus:ring-2 focus:ring-red-100 transition-all">
