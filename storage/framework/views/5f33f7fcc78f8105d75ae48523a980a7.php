...
<div class="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden mb-4">
    <div class="px-5 py-4 border-b border-gray-100 flex items-center justify-between">
        ...
        <a href="<?php echo e(route('clientes.index')); ?>" class="text-sm text-red-600 font-semibold hover:text-red-700">
            Ver todos →
        </a>
    </div>
                ...
                <a href="<?php echo e($url); ?>"
                   class="flex items-center gap-3 px-5 py-3.5 hover:bg-gray-50 transition-colors group">
                    ...
                    <div class="w-9 h-9 rounded-lg flex items-center justify-center flex-shrink-0
                        <?php echo e($visita->tipo === 'documento' ? 'bg-red-50' : 'bg-blue-50'); ?>">
                        <span class="text-lg">
                            <?php echo e($visita->tipo === 'documento' ? '📄' : '🖥️'); ?>
                    ...
                    <div class="flex-1 min-w-0">
                        <div class="text-sm font-medium text-gray-900 truncate group-hover:text-red-600 transition-colors">
                            <?php echo e($visita->recurso_nombre); ?>
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <div class="flex items-center gap-3 mt-1.5 flex-wrap">
                                ...
                                <a href="<?php echo e($aviso->url); ?>"
                                   class="text-xs text-red-600 font-semibold hover:text-red-700 transition-colors">
                                    <?php echo e($aviso->url_texto ?? 'Ver recurso'); ?> →
                                </a>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <span class="text-xs text-gray-400 font-mono">
                                    <?php echo e($aviso->publicado_at?->diffForHumans()); ?>

                                </span>
                                <span class="text-xs text-gray-300 font-mono">
                                    por <?php echo e($aviso->user->name ?? 'Admin'); ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if (\Illuminate\Support\Facades\Blade::check('role', 'admin')): ?>
                        <form method="POST" action="<?php echo e(route('avisos.destroy', $aviso)); ?>"
